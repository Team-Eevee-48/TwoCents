...
const mapDispatchToProps = (dispatch) => ({
  upVoteActionCreator: (itemId, user_id, votes) =>
    dispatch(actions.upVoteActionCreator(itemId, user_id, votes)),
});

const FeedbackItem = (props) => {
  const votes = props.feedbackItems[props.index].votes;
  ...
  return (
    <div className="feedbackItem">
      <button className="voteBtn" id={props.info._id} onClick={handleClick}>
        <span>&#9650;</span>
        {votes ?? 0}
      </button>
